...
import { initialPiercingFormData, type PiercingFormData } from './piercingTypes';
...
export default function PiercingWizard({ onServiceSaved }: PiercingWizardProps) {
  ...
  const { mutate: placeService, isPending } = usePlacePiercingService();
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-elegant">
        <CardHeader>
          <CardTitle>New Piercing Service</CardTitle>
        </CardHeader>
